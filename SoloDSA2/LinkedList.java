...
class LinkedList {
    ...
    public static void main(String[] args) {
        ...
        list.insertAtPos(80, 0); 
        list.insertAtPos(100, 1); 
        list.insertAtPos(120, 2); 
        list.insertAtPos(140, 1); 
        list.insertAtPos(160, 3);
        ...
        System.out.println("List after deleting the node after 80:");
        list.printList();
        ...
        if (foundNode != null) {
            System.out.println("Node with value 100 found.");
        } else {
            System.out.println("Node with value 100 not found.");
        }
